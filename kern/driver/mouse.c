...
void mouse_init() {
    ...
    memsetdw(next_mouse_region.region, 0x0000ff00, CURSOR_WIDTH * CURSOR_HEIGHT);
    // Cursoe icon
    cursor_icon = bmp_create("/cursor.bmp");
    current_mouse_region.r = next_mouse_region.r;
    bmp_to_framebuffer2(cursor_icon, current_mouse_region.region);
    // Draw the mouse
    rects[0] = next_mouse_region.r;
    draw_mouse();
